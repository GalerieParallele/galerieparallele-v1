    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.content}>
                ...
                {/*        placeholder={formData.artist.legalInformation.legalInformation.societe ? formData.artist.legalInformation.legalInformation.societe : "Ex: Dp Gallery"}*/}
                {/*        name={"legal.societe"}*/}
                {/*        value={formData.artist.legalInformation.legalInformation.societe}*/}
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.societe")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                ...
                {/*        type={"text"}*/}
                {/*        IconComponent={IoHome}*/}
                {/*        placeholder={formData.artist.legalInformation.legalInformation.adrNumVoie ? formData.artist.legalInformation.legalInformation.adrNumVoie : "Ex: 1"}*/}
                {/*        name={"legal.adrNumVoie"}*/}
                {/*        value={formData.artist.legalInformation.legalInformation.adrNumVoie}*/}
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.adrNumVoie")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                ...
                {/*        name={"legal.adrRue"}*/}
                {/*        value={formData.artist.legalInformation.legalInformation.adrRue}*/}
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.adrRue")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                {/*        label={"Ville"}*/}
                ...
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.adrVille")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                {/*        label={"Code postal"}*/}
                ...
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.adrCodePostal")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                ...
                {/*        placeholder={formData.artist.legalInformation.legalInformation.siret ? formData.artist.legalInformation.legalInformation.siret : "Ex: 12345678912345"}*/}
                {/*        name={"legal.siret"}*/}
                {/*        value={formData.artist.legalInformation.legalInformation.siret}*/}
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.siret")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                ...
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.tva")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                ...
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.numMaisonsDesArtistes")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*    <IconInput*/}
                ...
                {/*        onChange={updateFormData("artist.legalInformation.legalInformation.numSecuriteSociale")}*/}
                {/*        required*/}
                {/*    />*/}
                {/*</DashboardSectionItem>*/}
            </div>
